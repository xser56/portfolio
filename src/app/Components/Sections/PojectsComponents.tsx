 export interface ProjectProps
  ...
  <img 
    src={projectImg} 
    alt={projectImgAlt} 
    className="w-full max-w-md h-[250px] object-cover rounded-sm cursor-pointer transition duration-300 hover:scale-101 shadow-md"
  />
</a>

  <div className="w-full max-w-md h-auto bg-amber-100">
